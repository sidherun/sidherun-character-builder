...
- **Play Mode** — Live HP/Mana/Story Points tracking with quick-adjust buttons, armor that absorbs up to its soak value per hit, attributes/powers/magic at a glance, an **editable Inventory** section (add/edit/remove items — name, quantity, notes — during play), and per-skill **Use tracking** (strike circles as skills are used)
