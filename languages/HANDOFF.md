...
| Notion structure (all derived, never canonical) | **Languages** top-level page `3a2e8e2e-a25a-81f9-b29d-fbffeba11dce` under the Sidherun hub, holding the primitives mirror `3a1e8e2e-a25a-8153-a833-d1c4c0f976cf` and **Translated Stories** `3a2e8e2e-a25a-8131-a050-e8a16eb7d98d` |
| Text mirrors (under Translated Stories, "Quin'dhel" header) | Tem'wen `3a2e8e2e-a25a-818f-b2eb-f735aa1aa251` · Phrasebook `3a2e8e2e-a25a-81d1-a00e-d364248ade5a` · Malgrath'threl `3a2e8e2e-a25a-8153-86cc-d347b5f3ee4b` · Eth'lae `3a2e8e2e-a25a-8183-bd40-d74f49a0699e` — every new text gets a mirror there under its language's header (Ed's ruling: everything mirrors, completely); future languages (Hul, Dûrakhar) get their own header and primitives mirror under Languages |
...
1. **Player-facing content layer (#297, waiting on Ed's shape review).** Curated player-safe docs (`players/`) for the app and PHB — first deliverable `players/elves.md`. Content is Claude's; the app surface is Codex's; design the data contract first.
