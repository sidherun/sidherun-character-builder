...
1. **Player-facing content layer (#297, shape draft delivered 2026-07-19 — awaiting Ed's review).** The draft lives in `players/`: `players/README.md` carries the audience rule, derivation discipline, and the frontmatter data contract (the Codex seam); `players/elves.md` is the first deliverable. Open shape questions for Ed are listed at the end of `players/README.md` — the Aia'runor exposure line, Notion placement, and whether Tem'wen/Malgrath'threl get player-exposure audits. After Ed's review: Codex builds the app lore surface against the contract; next docs are races & kindreds, language primer, pantheon as worshipped.
