...
**Armor absorbs** incoming damage with the following formula:
...
- 4 - Padded armor
- 6 - Leather armor, Bark skin spell
- 8 - Chain and or scale armor
- 10 - heavy scale or 1/2 plate armor
- 12 - full steel armor
- 15 - Blue steel full plate armor

**Typical armor total values:**

<!-- NOTE: This exact 3-column table (same header text, same six rows of numbers) also appears earlier in the document (~line 1656) under "Notes on Armor's impact on Movement" in the Movement chapter (see rules/09-movement.md). Flagged as a verbatim duplicate appearing in two chapters — not resolving which is authoritative. -->

| For armor rated: | Typical total value is: | Shift Movement Left |
|---|---|---|
| 4 | 80 | 0 |
| 6 | 120 | 1 |
| 8 | 160 | 2 |
...
<!-- FIDELITY NOTE: For armor rated "8", this table states the typical total value is 160. This conflicts with the worked example above ("Armor absorbs incoming damage with the following formula:" / Oleg's chain mail), where 8-rated armor is described as "8/96(180)" — implying a max durability of 180, not 160, for armor rated 8. Reproduced verbatim from source; not reconciled. -->

**Special Note on Shields:**

While Shields do not offer absorption, they do act to add to defense. As such, the degradation of shields is tied to narrative and critical strike storylines.

Machine-readable version: rules/data/armor-values.json
